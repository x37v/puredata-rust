...
pub type t_float = f64;
pub type t_floatarg = f64;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _symbol {
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _instancemidi {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _instanceinter {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _instancecanvas {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _instanceugen {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _instancestuff {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _pdinstance {
    ...
    pub pd_instanceno: ::std::os::raw::c_int,
    ...
    pub pd_s_pointer: t_symbol,
    pub pd_s_float: t_symbol,
    pub pd_s_symbol: t_symbol,
    pub pd_s_bang: t_symbol,
    pub pd_s_list: t_symbol,
    pub pd_s_anything: t_symbol,
    pub pd_s_signal: t_symbol,
    pub pd_s__N: t_symbol,
    pub pd_s__X: t_symbol,
    pub pd_s_x: t_symbol,
    pub pd_s_y: t_symbol,
    pub pd_s_: t_symbol,
    pub pd_islocked: ::std::os::raw::c_int,
}
#[test]
fn bindgen_test_layout__pdinstance() {
    assert_eq!(
        ::std::mem::size_of::<_pdinstance>(),
        392usize,
        concat!("Size of: ", stringify!(_pdinstance))
    );
    assert_eq!(
        ::std::mem::align_of::<_pdinstance>(),
        8usize,
        concat!("Alignment of ", stringify!(_pdinstance))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_systime as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
            "::",
            stringify!(pd_systime)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_clock_setlist as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
            "::",
            stringify!(pd_clock_setlist)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_canvaslist as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
            "::",
            stringify!(pd_canvaslist)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_templatelist as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
            "::",
            stringify!(pd_templatelist)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_instanceno as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
            "::",
            stringify!(pd_instanceno)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_symhash as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
            "::",
            stringify!(pd_symhash)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_midi as *const _ as usize },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_inter as *const _ as usize },
        56usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_ugen as *const _ as usize },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_gui as *const _ as usize },
        72usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_stuff as *const _ as usize },
        80usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_newest as *const _ as usize },
        88usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_s_pointer as *const _ as usize },
        96usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
            "::",
            stringify!(pd_s_pointer)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_s_float as *const _ as usize },
        120usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
            "::",
            stringify!(pd_s_float)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_s_symbol as *const _ as usize },
        144usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
            "::",
            stringify!(pd_s_symbol)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_s_bang as *const _ as usize },
        168usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_s_list as *const _ as usize },
        192usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_s_anything as *const _ as usize },
        216usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
            "::",
            stringify!(pd_s_anything)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_s_signal as *const _ as usize },
        240usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
            "::",
            stringify!(pd_s_signal)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_s__N as *const _ as usize },
        264usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_s__X as *const _ as usize },
        288usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_s_x as *const _ as usize },
        312usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_s_y as *const _ as usize },
        336usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_s_ as *const _ as usize },
        360usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_pdinstance>())).pd_islocked as *const _ as usize },
        384usize,
        concat!(
            "Offset of field: ",
            stringify!(_pdinstance),
            "::",
            stringify!(pd_islocked)
        )
    );
}
extern "C" {
